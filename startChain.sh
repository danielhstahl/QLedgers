...
(cd ~/Documents/ExternalApps/quorum-examples/examples/7nodes;./init.sh ~/Documents/ExternalApps/quorum/build/bin;./start.sh ~/Documents/ExternalApps/quorum/build/bin)
